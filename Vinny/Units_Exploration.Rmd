...
---
#Residential Units
So to me there appears to be two different models happening. The first is everything up to about 4ish where there is a slow but steady gain. After that though the price seems to become pretty much a flat line for the extremely large values of the residential units. I'm unsure what is happening in that regard but I still tried to fit it
```{r, echo = FALSE}
...
#Odd extreme values
As for the massive units they all appear to be coops. I think I know what is happening. So that whole area appears to be one giant co-op (for example in the 3 buildings with the same largest gross square footage is a co-op with apparently two large apartment buildings and a lot of condos/townhouses that apparently form one neighborhood from my googling). Anyway, these people who own an apartment/house in the co-op sell and  occasionally information is listed with the co-op statistics (ie you bought a condo with 1200 sqft of living space but since you bought into the co-op its posted as the whole of it having some transaction.)
